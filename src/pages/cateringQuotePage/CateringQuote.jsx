...
const CateringQuote = () => {
    ...
    const validateForm = () => {
        // Required fields
        if (!formData.eventType || !formData.dateTime || !formData.numberOfGuests ||
            !formData.venue || !formData.name || !formData.email || !formData.phone) {
                ...
                <div className="bg-white rounded-lg shadow-sm p-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                            Select the dishes you'd like to include in your event. You can choose as many as you like.
                        </p>
