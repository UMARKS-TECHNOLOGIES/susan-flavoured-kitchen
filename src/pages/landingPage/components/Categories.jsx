...
const Categories = () => {
  ...
  return (
    <section>
      <div className="relative top-16 max-w-5xl mx-auto">
        <h3 className="text-3xl font-medium">Categories</h3>
        <div className="my-5 grid grid-cols-3 space-y-9">
          {categoryItems.map((items) => (
            <div
              key={items.id}
              className="relative w-80 h-50 items-center text-center flex justify-center bg-cover bg-no-repeat rounded-br-lg rounded-tl-lg"
              style={{
                backgroundImage: `url(${items.imageUrl})`,
              }}
            >
              <div className="bg-white/70 px-7 py-2 rounded-br-lg rounded-tl-lg">
