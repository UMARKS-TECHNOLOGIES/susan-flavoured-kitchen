        ...
        <div className="max-w-5xl mx-auto p-4 sm:p-6">
          ...
          <div
            className={`grid gap-6 ${
              cartItems.length > 0 ? "lg:grid-cols-3" : ""
            }`}
          >
            <div className={cartItems.length > 0 ? "lg:col-span-2" : ""}>
              <div className="bg-white rounded-lg shadow-md py-10 md:py-20 px-4 sm:px-6">
                {cartItems.length > 0 ? (
          ...
          <div className="mt-12">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-xl sm:text-3xl font-bold px-4">
                Start with Our Popular Choices
              </h2>
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 px-4 pt-10 mb-4 ">
                {popularDishes.map((dish) => (
                  <PopularDishCard key={dish.id} dish={dish} />
                ))}
              </div>
              <p className="text-center text-sm md:text-lg font-medium text-gray-500 my-6 px-4">
                All meals are freshly cooked, safely packaged, and delivered
                across the UK.
              </p>
            </div>
          </div>
