...
const SignupPage = () => {
  ...
  const validateForm = () => {
    ...
    // Password validation
    if (!passwordValidation.minLength || !passwordValidation.hasUppercase || !passwordValidation.hasSpecialChar) {
                      ...
                      <div className="space-y-2">
                          ...
                          {formData.password && (
                              <div className="space-y-1 text-xs mt-2">
                                  ...
                                  <div className={`flex items-center gap-1 ${passwordValidation.hasSpecialChar ? 'text-red-600' : 'text-gray-500'}`}>
