  ...
  const sections = [
    {
      title: "Description",
      text:
        data.description || "Delicious smoky Jollof Rice with grilled chicken.",
    },
    {
      title: "Ingredients",
      text: "Rice, tomatoes, pepper mix, spices, chicken.",
    },
    {
      title: "Hygiene Promise",
      text: "Prepared fresh in a clean environment.",
    },
